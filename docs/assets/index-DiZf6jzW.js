import{initializeApp as e}from"https://www.gstatic.com/firebasejs/10.12.0/firebase-app.js";import{collection as t,deleteDoc as n,doc as r,getDoc as i,getDocs as a,getFirestore as o,onSnapshot as s,setDoc as c,updateDoc as l}from"https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js";var u=(e,t)=>()=>(e&&(t=e(e=0)),t),d=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function f(e){_=e}function p(e){v=e}function m(e){y=e}var h,g,_,v,y,b=u((()=>{h=[`Elecnor`,`Sertori`,`Sirti`],g={Stefano:{hash:`6cf6ea93e6f6aea4b693ef7fb643686b01bbf00e6d38bab620008e074a895349`,role:`admin`},Piero:{hash:`83e3b78f14e08cc5e0bf037b1668b27bcde446cb05f04f86845deaf7812be71d`,role:`viewer`}},_=null,v=h[0],y=`live`}));function x(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function S(e){if(!e||e===`—`)return!1;try{let t=e.split(` `);if(t.length<2)return!1;let n=t[1],r=new Date;return n===String(r.getDate()).padStart(2,`0`)+`/`+String(r.getMonth()+1).padStart(2,`0`)+`/`+r.getFullYear()}catch{return!1}}function C(e){if(!e||e===`—`)return null;try{let[t,n]=e.split(` `),[r,i]=t.split(`:`),[a,o,s]=n.split(`/`);return new Date(s,o-1,a,r,i)}catch{return null}}function w(e){if(!e||e===`—`)return`—`;try{let[t,n]=e.split(` `),[r,i]=t.split(`:`),[a,o,s]=n.split(`/`),c=new Date(s,o-1,a,r,i),l=(Date.now()-c.getTime())/1e3/60,u=[`Dom`,`Lun`,`Mar`,`Mer`,`Gio`,`Ven`,`Sab`][c.getDay()];return l<2?`adesso`:l<60?`${Math.round(l)} min fa`:l<1440?`${Math.round(l/60)} ore fa`:l<1440*7?`${u} ${a}/${o}`:`tempo fa`}catch{return e}}function T(e){if(!e||e===`—`)return`status-red status-circle`;try{let[t,n]=e.split(` `),[r,i]=t.split(`:`),[a,o,s]=n.split(`/`),c=new Date(s,o-1,a,r,i),l=(Date.now()-c.getTime())/1e3/3600;return l<4?`status-green status-circle`:l<24?`status-yellow status-circle`:`status-red status-circle`}catch{return`status-red status-circle`}}function E(e){if(e===`live`)return`📡 Oggi (live)`;let[t,n,r]=e.split(`-`);return`${[`Dom`,`Lun`,`Mar`,`Mer`,`Gio`,`Ven`,`Sab`][new Date(t,n-1,r).getDay()]} ${r}/${n}/${t}`}function D(e,t=`info`,n=3500){let r={success:`✅`,error:`❌`,info:`ℹ️`,warning:`⚠️`},i=document.getElementById(`toast-container`),a=document.createElement(`div`);a.className=`toast toast-${t}`,a.innerHTML=`<span class="toast-icon">${r[t]||`ℹ️`}</span><span class="toast-msg">${x(e)}</span>`,a.addEventListener(`click`,()=>O(a)),i.appendChild(a),a._timer=setTimeout(()=>O(a),n)}function O(e){clearTimeout(e._timer),e.classList.add(`hide`),e.addEventListener(`animationend`,()=>e.remove(),{once:!0})}function k(e){let t=()=>e.querySelectorAll(`button:not([disabled]), input:not([disabled]), [tabindex]:not([tabindex="-1"])`),n=n=>{if(n.key!==`Tab`)return;let r=Array.from(t());if(r.length===0)return;let i=r[0],a=r[r.length-1];n.shiftKey?(document.activeElement===i||!e.contains(document.activeElement))&&(n.preventDefault(),a.focus()):(document.activeElement===a||!e.contains(document.activeElement))&&(n.preventDefault(),i.focus())};return e.addEventListener(`keydown`,n),()=>e.removeEventListener(`keydown`,n)}function A({title:e,msg:t,icon:n=`⚠️`,okLabel:r=`Conferma`,okAccent:i=!1}={}){return new Promise(a=>{document.getElementById(`confirm-icon`).textContent=n,document.getElementById(`confirm-title`).textContent=e||``,document.getElementById(`confirm-msg`).textContent=t||``;let o=document.getElementById(`confirm-ok`);o.textContent=r,o.className=`confirm-btn-ok`+(i?` btn-accent`:``);let s=document.getElementById(`confirm-overlay`);s.classList.add(`show`);let c=k(s.querySelector(`.confirm-box`)),l=e=>{s.classList.remove(`show`),c(),o.replaceWith(o.cloneNode(!0)),document.getElementById(`confirm-cancel`).replaceWith(document.getElementById(`confirm-cancel`).cloneNode(!0)),a(e)};document.getElementById(`confirm-ok`).addEventListener(`click`,()=>l(!0),{once:!0}),document.getElementById(`confirm-cancel`).addEventListener(`click`,()=>l(!1),{once:!0}),s.addEventListener(`click`,e=>{e.target===s&&l(!1)},{once:!0})})}function ee({title:e,defaultValue:t=``,icon:n=`✏️`}={}){return new Promise(r=>{document.getElementById(`rename-icon`).textContent=n,document.getElementById(`rename-title`).textContent=e||``;let i=document.getElementById(`rename-input`);i.value=t;let a=document.getElementById(`rename-overlay`);a.classList.add(`show`),requestAnimationFrame(()=>{i.focus(),i.select()});let o=k(a.querySelector(`.confirm-box`)),s=e=>{a.classList.remove(`show`),o(),document.getElementById(`rename-ok`).replaceWith(document.getElementById(`rename-ok`).cloneNode(!0)),document.getElementById(`rename-cancel`).replaceWith(document.getElementById(`rename-cancel`).cloneNode(!0)),i.removeEventListener(`keydown`,c),r(e)},c=e=>{e.key===`Enter`&&(e.preventDefault(),s(i.value.trim()||null)),e.key===`Escape`&&(e.preventDefault(),s(null))};i.addEventListener(`keydown`,c),document.getElementById(`rename-ok`).addEventListener(`click`,()=>s(i.value.trim()||null),{once:!0}),document.getElementById(`rename-cancel`).addEventListener(`click`,()=>s(null),{once:!0}),a.addEventListener(`click`,e=>{e.target===a&&s(null)},{once:!0})})}var j=u((()=>{})),te,M,N=u((()=>{te=e({apiKey:`AIzaSyAF6vv0cHkzNaheOsNG52fGI9kLeuV4UJg`,authDomain:`technicalwork-cloud.firebaseapp.com`,projectId:`technicalwork-cloud`,storageBucket:`technicalwork-cloud.firebasestorage.app`,messagingSenderId:`882243863479`,appId:`1:882243863479:web:2d57dbc9741e45e8cb1e32`}),M=o(te)}));async function ne(e,t,n){let r=document.querySelector(`.btn-export`),i=r?r.innerHTML:null;r&&(r.disabled=!0,r.innerHTML=`<span class="btn-spinner"></span> Generazione…`);try{typeof ExcelJS>`u`&&await new Promise((e,t)=>{let n=document.createElement(`script`);n.src=`https://cdnjs.cloudflare.com/ajax/libs/exceljs/4.3.0/exceljs.min.js`,n.onload=e,n.onerror=()=>t(Error(`Impossibile caricare ExcelJS. Controlla la connessione.`)),document.head.appendChild(n)});let r=new Date().toLocaleDateString(`it-IT`),i=n.filter(e=>!/^::.*::$/.test(e.trim())&&!/^;;.*;;$/.test(e.trim())),a=new ExcelJS.Workbook;a.creator=`TechnicalWork`;let o=a.addWorksheet(e),s=t.length+2,c=`Segoe UI`,l=`FF1A2B3C`,u=`FFFFFFFF`,d=`FF212529`,f=`FF0D6EFD`,p=`FFE7F1FF`,m={top:{style:`thin`,color:{argb:`FFDEE2E6`}},bottom:{style:`thin`,color:{argb:`FFDEE2E6`}},left:{style:`thin`,color:{argb:`FFDEE2E6`}},right:{style:`thin`,color:{argb:`FFDEE2E6`}}},h={top:{style:`thin`,color:{argb:`FFDEE2E6`}},bottom:{style:`thin`,color:{argb:`FFDEE2E6`}}};o.getColumn(1).width=40;for(let e=2;e<=t.length+1;e++)o.getColumn(e).width=14;o.getColumn(t.length+2).width=11;let g=o.addRow([`TECHNICALWORK — LISTA MODEM`]);o.mergeCells(1,1,1,s),g.height=30;let _=g.getCell(1);_.font={name:c,size:13,bold:!0,color:{argb:u}},_.fill={type:`pattern`,pattern:`solid`,fgColor:{argb:l}},_.alignment={horizontal:`center`,vertical:`middle`};let v=o.addRow([`${e.toUpperCase()}   ·   ${r}`]);o.mergeCells(2,1,2,s),v.height=22;let y=v.getCell(1);y.font={name:c,size:10,bold:!1,color:{argb:`FFAABCCC`}},y.fill={type:`pattern`,pattern:`solid`,fgColor:{argb:l}},y.alignment={horizontal:`center`,vertical:`middle`};let b=o.addRow([]);o.mergeCells(3,1,3,s),b.height=8,b.getCell(1).fill={type:`pattern`,pattern:`solid`,fgColor:{argb:u}};let x=[`MATERIALE`,...t.map(e=>(e.tecnico||e.id).toUpperCase()),`TOT`],S=o.addRow(x);S.height=22,S.eachCell((e,t)=>{let n=t===s;e.font={name:c,size:9,bold:!0,color:{argb:n?f:u}},e.fill={type:`pattern`,pattern:`solid`,fgColor:{argb:n?p:`FF2C3E50`}},e.alignment={horizontal:t===1?`left`:`center`,vertical:`middle`},e.border={bottom:{style:`medium`,color:{argb:n?f:`FF4A6278`}}}}),i.forEach((e,n)=>{let r=n%2==1?`FFF8F9FA`:u,i=[e,...t.map(t=>{let n=t.materiali&&t.materiali[e]||``;return n===`0`||n===0?``:n}),``],a=o.addRow(i);a.height=20,a.eachCell({includeEmpty:!0},(e,t)=>{let n=t===s,i=e.value?String(e.value).trim():``,a=i===``||i===`0`;e.fill={type:`pattern`,pattern:`solid`,fgColor:{argb:r}},e.alignment={horizontal:t===1?`left`:`center`,vertical:`middle`},e.border=h,t===1?(e.font={name:c,size:9,bold:!0,color:{argb:d}},e.border=m):n?(e.font={name:c,size:9,bold:!0,color:{argb:f}},e.fill={type:`pattern`,pattern:`solid`,fgColor:{argb:p}},e.border=m):(e.font={name:c,size:9,bold:!a,color:{argb:a?`FFADB5BD`:d}},e.border=m)})});let C=await a.xlsx.writeBuffer(),w=new Blob([C],{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}),T=URL.createObjectURL(w),E=document.createElement(`a`);E.href=T,E.download=`${e}_${r.replace(/\//g,`-`)}.xlsx`,E.click(),URL.revokeObjectURL(T),D(`File "${e}_${r.replace(/\//g,`-`)}.xlsx" scaricato.`,`success`)}catch(e){D(`Errore durante l'esportazione: `+e.message,`error`,5e3),console.error(e)}finally{r&&i&&(r.disabled=!1,r.innerHTML=i)}}function re(e,t,n){let r=new Date().toLocaleDateString(`it-IT`),i=n.filter(e=>!/^::.*::$/.test(e.trim())&&!/^;;.*;;$/.test(e.trim())),a=``;i.forEach((e,n)=>{let r=n%2==1?`#F8F9FA`:`#FFFFFF`,i=`<td style="padding:4px 6px;font-weight:600;font-size:10px;border:1px solid #DEE2E6;background:${r};white-space:nowrap">${e}</td>`;t.forEach(t=>{let n=t.materiali&&t.materiali[e]||``,a=n===`0`||n===0?``:n,o=a===``;i+=`<td style="padding:4px 6px;text-align:center;font-size:10px;border:1px solid #DEE2E6;background:${r};color:${o?`#ADB5BD`:`#212529`};font-weight:${o?`normal`:`600`};white-space:nowrap">${a||`·`}</td>`}),i+=`<td style="padding:4px 6px;text-align:center;border:1px solid #DEE2E6;background:#E7F1FF;min-width:35px"></td>`,a+=`<tr>${i}</tr>`});let o=`<th style="padding:6px 6px;text-align:left;background:#2C3E50;color:white;font-size:10px;border:1px solid #4A6278">MATERIALE</th>`;t.forEach(e=>{o+=`<th style="padding:6px 6px;text-align:center;background:#2C3E50;color:white;font-size:10px;border:1px solid #4A6278;white-space:nowrap">${(e.tecnico||e.id).toUpperCase()}</th>`}),o+=`<th style="padding:6px 6px;text-align:center;background:#E7F1FF;color:#0D6EFD;font-size:10px;border:1px solid #B6D4FE">TOT</th>`;let s=`
    ...
    <\/script>
    </body></html>`,c=window.open(``,`_blank`,`width=1100,height=700`);c.document.write(s),c.document.close()}var ie=u((()=>{j()})),ae,oe,P,se,ce=u((()=>{ae=`modulepreload`,oe=function(e,t){return new URL(e,t).href},P={},se=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=oe(t,n),t in P)return;P[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:ae,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));async function F(){if(V!==null)return V;try{let e=await i(r(M,`settings`,`hidden_tecnici`));V=e.exists()&&e.data().hidden||[]}catch{V=[]}return V}async function I(e){V=e;try{await c(r(M,`settings`,`hidden_tecnici`),{hidden:e})}catch(e){console.error(`Errore salvataggio nascosti`,e)}}function le(){return H}async function L(){for(let e of h)H[e]||(H[e]=s(t(M,e),async t=>{let n=await F(),r=t.docs.filter(e=>{if(/_\d{4}-\d{2}-\d{2}$/.test(e.id))return!1;let t=e.data();if(n.includes(t.tecnico||e.id)||!S(t.ultimo_aggiornamento))return!1;let r=t.materiali;return r?Object.values(r).some(e=>e!==``&&e!==`0`&&e!==0):!1}),i=document.getElementById(`cnt-`+e);i&&(i.textContent=r.length,r.length>0?i.style.color=`var(--accent)`:i.style.color=``)}))}function ue(e){window.location.hash=`#/appalti/${v}/${e}`}function R(){document.querySelectorAll(`.snapshot-dropdown.open`).forEach(e=>{e.classList.remove(`open`);let t=e.querySelector(`.snapshot-trigger`);t&&t.setAttribute(`aria-expanded`,`false`)})}function de(e){e.stopPropagation();let t=e.currentTarget.closest(`.snapshot-dropdown`);if(!t)return;let n=t.classList.contains(`open`);if(R(),!n){t.classList.add(`open`),e.currentTarget.setAttribute(`aria-expanded`,`true`);let n=t.querySelector(`.snapshot-option.active`),r=t.querySelector(`.snapshot-option`),i=n||r;i&&i.focus()}}function fe(e){R(),ue(e)}function pe(e,t){document.querySelectorAll(`.sidebar-item`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),p(e),m(`live`),V=null,document.getElementById(`tb-appalto`).textContent=e,z(e,`live`),he()}function me(){let e=document.querySelector(`.sidebar`),t=document.getElementById(`sidebar-overlay`);e.classList.contains(`open`)?he():(e.classList.add(`open`),t.classList.add(`show`))}function he(){let e=document.querySelector(`.sidebar`),t=document.getElementById(`sidebar-overlay`);e&&e.classList.remove(`open`),t&&t.classList.remove(`show`)}async function ge(){let e=[`lista`,`elecnor`,`sertori`,`sirti`].map(e=>e.toLowerCase());for(let t of e)localStorage.removeItem(`tw_list_${t}`),localStorage.removeItem(`tw_list_time_${t}`),delete U[t];try{let{doc:e,setDoc:t}=await se(async()=>{let{doc:e,setDoc:t}=await import(`https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js`);return{doc:e,setDoc:t}},[],import.meta.url);await t(e(M,`settings`,`dashboard`),{forceListUpdate:Date.now()},{merge:!0})}catch{}}async function _e(e){let t=e.toLowerCase();if(U[t])return U[t];let n=`tw_list_${t}`,a=`tw_list_time_${t}`,o=localStorage.getItem(n),s=localStorage.getItem(a),c=Date.now(),l=0;try{let e=await i(r(M,`settings`,`dashboard`));e.exists()&&(l=e.data().forceListUpdate||0)}catch{}let u=!s||c-parseInt(s)>864e5;if(o&&!u&&!(parseInt(s||0)<l))try{return U[t]=JSON.parse(o),U[t]}catch{}let d=[`:: MATERIALE ACCESSORIO ::`,`PTE / MU`,`ROE / ROEL`,`CAVO DROP (MT)`,`MINIPRESA / BORCHIA`,`MODEM / ONT`,`:: ALTRO ::`,`RIFLETTORE`,`SISTEMAZIONE LOCALI`],f=null;try{let t=`https://raw.githubusercontent.com/gmaclol/Technicalwork-Materiali/master/lists/${e}.txt`,r=await fetch(t);if(r.status===404&&(t=`https://raw.githubusercontent.com/gmaclol/Technicalwork-Materiali/master/lists/lista.txt`,r=await fetch(t)),r.status===200){let e=(await r.text()).split(/\r?\n/).map(e=>e.trim()).filter(e=>e!==``);e.length>0&&(f=e,localStorage.setItem(n,JSON.stringify(e)),localStorage.setItem(a,c.toString()))}else console.warn(`GitHub risponde con errore`,r.status,`su`,e)}catch(e){console.error(`Errore di rete o CORS nel fetch della raw list:`,e)}if(!f&&o)try{f=JSON.parse(o),console.log(`Rete o GitHub bloccati, ripiego sulla cache locale di 24h.`)}catch{}return U[t]=f||d,U[t]}async function ve(e,t,n,r){e.preventDefault();let i=document.getElementById(`loc-`+t);if(!i||i.dataset.loaded){window.open(i.href,`_blank`);return}i.textContent=`⊙ caricamento...`;let a=`${n}_${r}`;try{let e=``;if(W[a])e=W[a];else{let t=await(await fetch(`https://nominatim.openstreetmap.org/reverse?lat=${n}&lon=${r}&format=json`)).json(),i=t.address;e=i.road?`${i.road}${i.house_number?` `+i.house_number:``}, ${i.city||i.town||i.village||``}`:t.display_name.split(`,`).slice(0,2).join(`,`),W[a]=e}i.textContent=`⊙ `+e.trim(),i.dataset.loaded=`1`}catch{i.textContent=`⊙ ${Number(n).toFixed(4)}, ${Number(r).toFixed(4)}`,i.dataset.loaded=`1`}}function ye(e){let t=e&&e.closest?e.closest(`.table-scroll`):null;if(!t){e.scrollIntoView({inline:`center`,behavior:`smooth`,block:`nearest`});return}let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=t.scrollLeft+(n.left-r.left+n.width/2)-r.width/2;t.scrollTo({left:Math.max(0,i),behavior:`smooth`})}function be(e,t){let n=e&&e.closest?e.closest(`th`):null;if(!n)return;let r=n.parentElement;if(!r||!r.children)return;let i=Array.from(r.children).filter(e=>e.tagName===`TH`),a=i[i.indexOf(n)+t];a&&ye(a)}function xe(e){let t=e.trim().toLowerCase(),n=document.querySelectorAll(`tbody tr`),r=null,i=!1;n.forEach(e=>{if(e.classList.contains(`separator-row`))r&&(r.style.display=i?``:`none`),r=e,i=!1;else{let n=e.dataset.material||``,r=t===``||n.includes(t);e.style.display=r?``:`none`,r&&(i=!0)}}),r&&(r.style.display=i?``:`none`)}function Se(e){let t=0;e.forEach(e=>{e.materiali&&Object.values(e.materiali).forEach(e=>{let n=parseInt(e);!isNaN(n)&&n>0&&(t+=n)})});let n=null,r=`—`;e.forEach(e=>{let t=C(e.ultimo_aggiornamento);t&&(!n||t>n)&&(n=t,r=e.ultimo_aggiornamento)});let i=document.getElementById(`kpi-total`),a=document.getElementById(`kpi-tecnici`),o=document.getElementById(`kpi-sync`);i&&(i.textContent=t.toLocaleString(`it-IT`)),a&&(a.textContent=e.length),o&&(o.textContent=w(r))}async function z(e,n=`live`){V=null;let r=document.getElementById(`content`);r.innerHTML=`
    <div class="state-box">
      <div class="loader-spinner"></div>
      <p>Recupero dati ${e}…</p>
    </div>`,J&&=(J(),null),G=null;try{if(n===`live`)J=s(t(M,e),async t=>{let i=[];t.forEach(e=>i.push({id:e.id,...e.data()}));let a=await F(),o=i.filter(e=>!/_\d{4}-\d{2}-\d{2}$/.test(e.id)).filter(e=>!a.includes(e.tecnico||e.id)).filter(e=>S(e.ultimo_aggiornamento)).filter(e=>{let t=e.materiali;return t?Object.values(t).some(e=>e!==``&&e!==`0`&&e!==0):!1}),s=document.getElementById(`cnt-`+e);s&&(s.textContent=o.length,o.length>0?s.style.color=`var(--accent)`:s.style.color=``);let c=await _e(e);if(o.length===0){if(c.length===0){r.innerHTML=`
              <div class="state-box fade-in">
                <h2>Nessun dato</h2>
                <p>Nessun tecnico ha ancora sincronizzato per <strong>${e}</strong>.</p>
              </div>`;return}G=null,B(e,[],r,n,i,c);return}B(e,o,r,n,i,c)},e=>{console.error(e),r.innerHTML=`<div class="state-box fade-in"><p>Errore connessione Live.</p></div>`});else{let i=await a(t(M,e)),o=[];i.forEach(e=>o.push({id:e.id,...e.data()}));let s=o.filter(e=>e.id.endsWith(`_`+n)),c=await F(),l=s.map(e=>({...e,id:e.id.replace(`_`+n,``),tecnico:e.tecnico||e.id.replace(`_`+n,``)})).filter(e=>!c.includes(e.tecnico||e.id)),u=await _e(e);if(l.length===0){B(e,[],r,n,o,u);return}B(e,l,r,n,o,u)}}catch(e){r.innerHTML=`
      <div class="state-box fade-in">
        <h2 style="color:var(--red)">Errore</h2>
        <p>Impossibile caricare i dati. Controlla la connessione.</p>
      </div>`,console.error(e)}}function B(e,t,n,r=`live`,i=[],a=[]){let o=a&&a.length>0?a:t.find(e=>e.ordine&&e.ordine.length>0)?.ordine||[],s=new Set(o),c=[],l=new Set,u=new Map;t.forEach(e=>{e.materiali&&Object.keys(e.materiali).forEach(t=>{let n=e.materiali[t];(n===`0`||n===0?``:String(n))!==``&&(s.has(t)||(l.has(t)||(l.add(t),c.push(t)),u.has(t)||u.set(t,new Set),u.get(t).add(e.tecnico||e.id)))})});let d=[...c,...o];d=d.filter(e=>!/^::.*::$/.test(e.trim())&&!/^;;.*;;$/.test(e.trim()));let f=new Set(c);if(t.length===0&&a&&a.length>0&&(d=a),d.length===0){n.innerHTML=`
      <div class="state-box fade-in">
        <h2>Nessun materiale</h2>
        <p>I dati non contengono materiali.</p>
      </div>`;return}let p=`${e}:${r}`,m=t.map(e=>e.tecnico||e.id);if(G===p&&m.length===K.length&&m.every((e,t)=>e===K[t])&&n.querySelector(`table`)&&window._lastMaterials&&window._lastMaterials.length===d.length){t.forEach((e,t)=>{let r=e.tecnico||e.id;d.forEach(i=>{if(/^::.*::$/.test(i.trim())||/^;;.*;;$/.test(i.trim()))return;let a=e.materiali&&e.materiali[i]||``,o=a===`0`||a===0?``:String(a),s=`${r}:${i}`;if(q.get(s)!==o){let e=n.querySelector(`tr[data-material="${CSS.escape(i.toLowerCase())}"]`);if(e){let n=e.children[t+1];if(n){let e=o===``?`empty`:`has-value`,t=o===``?`·`:o;n.className=`td-value ${e}`,n.textContent=t}}q.set(s,o)}});let i=e.ultimo_aggiornamento||`—`,a=n.querySelectorAll(`.tech-time`)[t];a&&(a.textContent=w(i),a.title=i);let o=n.querySelectorAll(`.tech-name`)[t];if(o){let e=o.querySelector(`.status-circle`);e&&(e.className=T(i))}});let e=n.querySelector(`.content-subtitle`);if(e){let n=r!==`live`;e.innerHTML=`${t.length} tecnici · ${d.length} materiali${n?` · <span style="color:var(--yellow)">snapshot</span>`:``}`}_&&_.role===`admin`&&Se(t),window._lastTecnici=t,window._lastMaterials=d;return}let h=document.getElementById(`material-search`)?.value||``,g=new Date().getFullYear()+`-`+String(new Date().getMonth()+1).padStart(2,`0`)+`-`+String(new Date().getDate()).padStart(2,`0`),v=i.map(e=>e.id),y=[...new Set(v.map(e=>{let t=e.match(/_(\d{4}-\d{2}-\d{2})$/);return t?t[1]:null}).filter(e=>!!e&&e!==g))].sort().reverse().slice(0,7),b=[{value:`live`,label:`📡 Oggi (live)`}];y.forEach(e=>{b.push({value:e,label:E(e)})});let S=b.find(e=>e.value===r)||b[0],D=b.map(e=>`
    ...
    >${x(e.label)}</button>
  `).join(``),O=r!==`live`,k=_&&_.role===`admin`,A=`
    <div class="content-header fade-in">
      <div>
        <div class="content-title">${e}</div>
        <div class="content-subtitle">${t.length} tecnici · ${d.length} materiali${O?` · <span style="color:var(--yellow)">snapshot</span>`:``}</div>
      </div>
    ...
    </div>`;if(k&&t.length>0){let e=0;t.forEach(t=>{t.materiali&&Object.values(t.materiali).forEach(t=>{let n=parseInt(t);!isNaN(n)&&n>0&&(e+=n)})});let n=null,r=`—`;t.forEach(e=>{let t=C(e.ultimo_aggiornamento);t&&(!n||t>n)&&(n=t,r=e.ultimo_aggiornamento)}),A+=`
    <div class="kpi-grid fade-in">
      ...
      <div class="kpi-card">
        <div class="kpi-icon">🔄</div>
        <div class="kpi-value" id="kpi-sync">${w(r)}</div>
    ...
    <div class="search-wrap">
    ...
    </div>`),A+=`<div class="table-scroll fade-in">`,t.length===0?A+=`
      ...
      <table>
        ...
        <tbody>`,d.forEach(e=>{let n=/^::.*::$/.test(e.trim())||/^;;.*;;$/.test(e.trim());if(n){let n=e.replace(/^[:;]+|[:;]+$/g,``).trim();A+=`
          <tr class="separator-row" data-sep="${x(n)}">
            <td colspan="${t.length+1}">${n}</td>
          </tr>`;return}let r=f.has(e)&&!n,i=r?` class="extra-row"`:``,a=``;r&&u.has(e)&&(a=` title="Inserito da: ${x(Array.from(u.get(e)).join(`, `))}"`),A+=`<tr data-material="${x(e.toLowerCase())}"${i}><td class="td-material"${a}>${e}</td>`,t.forEach(t=>{let n=t.materiali&&t.materiali[e]||``,r=n===`0`||n===0?``:n;A+=`<td class="td-value ${r===``?`empty`:`has-value`}">${r===``?`·`:r}</td>`}),A+=`</tr>`}),A+=`</tbody></table>`),A+=`</div>`,n.innerHTML=A,window._lastTecnici=t,window._lastMaterials=d,G=p,K=[...m],q=new Map,t.forEach(e=>{let t=e.tecnico||e.id;d.forEach(n=>{if(/^::.*::$/.test(n.trim())||/^;;.*;;$/.test(n.trim()))return;let r=e.materiali&&e.materiali[n]||``,i=r===`0`||r===0?``:String(r);q.set(`${t}:${n}`,i)})}),h){let e=document.getElementById(`material-search`);e&&(e.value=h,xe(h))}}var V,H,U,W,G,K,q,J,Y=u((()=>{N(),b(),j(),ce(),V=null,H={},U={},W={},G=null,K=[],q=new Map,J=null}));async function Ce(e){let t=await crypto.subtle.digest(`SHA-256`,new TextEncoder().encode(e));return Array.from(new Uint8Array(t)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}async function we(){let e=document.getElementById(`inp-user`).value.trim(),t=document.getElementById(`inp-pass`).value,n=document.getElementById(`login-error`),r=await Ce(t);g[e]&&g[e].hash===r?(f({name:e,role:g[e].role}),localStorage.setItem(`tw_session`,JSON.stringify({name:e,role:g[e].role})),Te()):(n.style.display=`block`,setTimeout(()=>n.style.display=`none`,3e3))}function Te(){document.getElementById(`login-screen`).style.display=`none`;let e=document.getElementById(`app`);e.style.display=`flex`,document.getElementById(`tb-user`).textContent=_.name+` — Esci`;let t=document.getElementById(`nav-tecnici-wrapper`);_.role===`admin`?t.style.display=`block`:t.style.display=`none`,L(),!window.location.hash||window.location.hash===`#/`?window.location.hash=`#/appalti/${h[0]}/live`:window.dispatchEvent(new HashChangeEvent(`hashchange`))}function Ee(){A({title:`Disconnessione`,msg:`Sei sicuro di voler uscire dalla dashboard?`,icon:`👋`,okLabel:`Esci`,okAccent:!0}).then(e=>{e&&(f(null),localStorage.removeItem(`tw_session`),document.getElementById(`login-screen`).style.display=`flex`,document.getElementById(`app`).style.display=`none`,document.getElementById(`inp-pass`).value=``)})}function De(){try{let e=localStorage.getItem(`tw_session`);if(e){let t=JSON.parse(e);t&&g[t.name]&&t.role===g[t.name].role&&(f(t),window.addEventListener(`load`,Te))}}catch{localStorage.removeItem(`tw_session`)}}var Oe=u((()=>{b(),j(),Y()}));async function ke(e){if(Q[e])return Q[e];try{let t=await fetch(Fe+Z[e]+`.md`);if(!t.ok)return Q[e]=new Map,Q[e];let n=await t.text(),r=new Map,i=n.split(/[·\n]/);for(let e of i){let t=e.split(/[：:]/);if(t.length<2)continue;let n=t[0],i=t.slice(1).join(`:`).trim().replace(/\s+(Global|China|Japan.*|US.*|Canada|South Korea|India.*)$/i,``).trim(),a=/`([^`]+)`/g,o,s=!1;for(;(o=a.exec(n))!==null;)s=!0,r.set(o[1].trim().toUpperCase(),i);if(!s){let e=n.match(/([A-Za-z0-9\-_]+)\s*$/);e&&r.set(e[1].trim().toUpperCase(),i)}}return Q[e]=r,r}catch{return Q[e]=new Map,Q[e]}}async function Ae(e){if(!e||e===`—`)return e;let t=e.trim().split(/\s+/),n=t[0].toLowerCase(),r=t.slice(1).join(` `).toUpperCase(),i=Object.keys(Z).find(e=>n.includes(e));if(!i)return e;let a=(await ke(i)).get(r);return a?`${t[0]} ${a}`:e}function je(){let e=le();for(let t in e)e[t]&&e[t](),delete e[t]}async function X(){document.querySelectorAll(`.sidebar-item`).forEach(e=>e.classList.remove(`active`));let e=document.getElementById(`nav-Tecnici`);e&&e.classList.add(`active`);let n=document.getElementById(`content`);if(_.role!==`admin`){n.innerHTML=`<div class="state-box fade-in"><h2>Accesso Negato</h2><p>Non hai i permessi per visualizzare questa pagina.</p></div>`;return}n.innerHTML=`<div class="state-box"><div class="loader-spinner"></div><p>Caricamento tecnici…</p></div>`;try{let e=new Map;for(let n of h)(await a(t(M,n))).docs.filter(e=>!/_\d{4}-\d{2}-\d{2}$/.test(e.id)).forEach(t=>{let r=t.data(),i=r.tecnico||t.id;e.has(i)||e.set(i,{docIds:{},dispositivo:r.dispositivo||`—`,versione:r.versione_app||``,appalti:[],ultimo:r.ultimo_aggiornamento||`—`}),e.get(i).appalti.push(n),e.get(i).docIds[n]=t.id});if(e.size===0){n.innerHTML=`<div class="state-box fade-in"><p>Nessun tecnico trovato.</p></div>`;return}let r=``,i=await F();for(let[t,n]of e){let e=!i.includes(t),a=await Ae(n.dispositivo),o=n.versione?` · <span style="color:var(--accent)">${n.versione}</span>`:``,s=t.replace(/'/g,`\\'`),c=JSON.stringify(n.docIds).replace(/'/g,`&#39;`).replace(/"/g,`&quot;`);r+=`<div class="toggle-wrap">
      ...
      <div class="table-scroll" style="padding:0; margin-top:0">
        ...
        </tr>`}),s+=`</tbody></table></div></div></div>`,n.innerHTML=s}catch(e){n.innerHTML=`<div class="state-box fade-in"><p>Errore caricamento dati PFS.</p></div>`,console.error(e)}}function Le(e,t){document.querySelectorAll(`.`+e+`-check`).forEach(e=>e.checked=t),Re()}function Re(){let e=document.querySelectorAll(`.sig-check:checked, .log-check:checked`),t=document.getElementById(`pfs-delete-toolbar`),n=document.getElementById(`pfs-delete-count`);e.length>0?(t.style.display=`flex`,n.textContent=`${e.length} elementi selezionati`):t.style.display=`none`}async function ze(e,t){if(await A({title:`Eliminare elemento?`,msg:`L'operazione è irreversibile.`,icon:`🗑️`,okLabel:`Elimina`}))try{await n(r(M,t,e)),D(`Elemento eliminato.`,`success`),$()}catch(e){D(`Errore: `+e.message,`error`,5e3)}}async function Be(){let e=document.querySelectorAll(`.sig-check:checked, .log-check:checked`),t=e.length;if(!await A({title:`Eliminare ${t} element${t===1?`o`:`i`}?`,msg:`L'operazione è irreversibile e coinvolge tutti gli elementi selezionati.`,icon:`🗑️`,okLabel:`Elimina ${t} element${t===1?`o`:`i`}`}))return;let i=document.querySelector(`.btn-bulk-delete`);i&&(i.innerHTML=`<span class="btn-spinner" style="border-color:rgba(255,255,255,0.3);border-top-color:white"></span> Eliminazione…`,i.disabled=!0);try{let i=[];e.forEach(e=>{let t=e.closest(`tr`),a=t.dataset.id,o=t.dataset.coll;i.push(n(r(M,o,a)))}),await Promise.all(i),D(`${t} element${t===1?`o eliminato`:`i eliminati`}.`,`success`),$()}catch(e){D(`Errore durante la cancellazione multipla: `+e.message,`error`,5e3),i&&(i.textContent=`Elimina Selezionati`,i.disabled=!1)}}var Ve=u((()=>{N(),j(),b()}));d((()=>{b(),j(),Oe(),Y(),Ie(),Ve(),ie();function e(e){document.documentElement.setAttribute(`data-theme`,e);let t=document.getElementById(`btn-theme`);t&&(t.textContent=e===`dark`?`🌙`:`☀️`);let n=document.querySelector(`meta[name="theme-color"]`);n&&(n.content=e===`dark`?`#020617`:`#f1f5f9`),localStorage.setItem(`tw_theme`,e)}function t(){e((document.documentElement.getAttribute(`data-theme`)||`dark`)===`dark`?`light`:`dark`)}e(localStorage.getItem(`tw_theme`)||`dark`);function n(){let e=document.getElementById(`offline-banner`);e&&(navigator.onLine?e.classList.remove(`show`):e.classList.add(`show`))}window.addEventListener(`online`,n),window.addEventListener(`offline`,n),document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`sidebar-appalti`);e&&(e.innerHTML=h.map((e,t)=>`
    ...
    `).join(``))});function r(){let e=document.getElementById(`login-screen`);if(e&&e.style.display!==`none`)return;let t=window.location.hash.slice(1);if(!t||t===`/`){window.location.hash=`#/appalti/${h[0]}/live`;return}let n=t.split(`/`).filter(Boolean),r=n[0];if(r===`admin`){let e=n[1];e===`tecnici`?X():e===`pfs`&&$()}else if(r===`appalti`){let e=n[1]||h[0],t=n[2]||`live`;document.querySelectorAll(`.sidebar-item`).forEach(e=>e.classList.remove(`active`));let r=document.getElementById(`nav-`+e);r&&r.classList.add(`active`),p(e),m(t),document.getElementById(`tb-appalto`).textContent=e,z(e,t)}}window.addEventListener(`hashchange`,r),document.addEventListener(`keydown`,e=>{if(e.key!==`Enter`)return;let t=document.getElementById(`login-screen`).style.display!==`none`,n=document.getElementById(`confirm-overlay`).classList.contains(`show`)||document.getElementById(`rename-overlay`).classList.contains(`show`);t&&!n&&we()}),document.addEventListener(`keydown`,e=>{let t=document.querySelector(`.snapshot-dropdown.open`);if(!t)return;let n=Array.from(t.querySelectorAll(`.snapshot-option`));if(!n.length)return;let r=n.findIndex(e=>e===document.activeElement);if(e.key===`ArrowDown`)e.preventDefault(),n[(r+1+n.length)%n.length].focus();else if(e.key===`ArrowUp`)e.preventDefault(),n[(r-1+n.length)%n.length].focus();else if(e.key===`Enter`&&r>=0){e.preventDefault();let t=n[r].getAttribute(`data-value`);t&&fe(t)}else e.key===`Escape`&&R()}),document.addEventListener(`click`,R),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&R()}),De(),window.doLogin=we,window.doLogout=Ee,window.toggleTheme=t,window.toggleDrawer=me,window.closeDrawer=he,window.selectAppalto=pe,window.loadAppalto=z,window.refreshData=()=>z(v,y),window.onDateChange=ue,window.toggleSnapshotDropdown=de,window.pickSnapshotDate=fe,window.closeSnapshotDropdown=R,window.filterMaterials=xe,window.scrollCellIntoViewCenter=ye,window.scrollTechHeaderNeighbor=be,window.loadGeo=ve,window.exportToExcel=ne,window.printTable=re,window.showTecnici=X,window.deleteTecnico=Me,window.renameTecnico=Ne,window.toggleTecnico=Pe,window.showPfsDashboard=$,window.toggleAllPfs=Le,window.updatePfsToolbar=Re,window.deletePfsItem=ze,window.deleteSelectedPfs=Be,window.showToast=D,window.forceUpdateLists=async()=>{if(confirm(`Vuoi forzare l'aggiornamento delle liste di tutti gli appalti da GitHub? L'operazione ripulirà la cache locale.`)){let e=document.getElementById(`btn-update-lists`);e&&(e.innerHTML=`<div class="loader-spinner" style="width:14px;height:14px;border-width:2px;display:inline-block;vertical-align:middle;margin-right:6px"></div> Attendere...`),await ge(),window.location.reload()}}}))();